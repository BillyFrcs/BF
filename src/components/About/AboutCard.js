      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            My stronger and passionate is to create <span className="purple">Game Mechanics</span>, Design Patterns and Scripting with Object Oriented Programming Language especially in <span className="purple">.NET C#</span> and doing some Debugging and Testing to find bugs and Optimizing Games.
            I also have some good knowledge with <span className="purple">C/C++ and Java.</span>
            <br />
            <br />
