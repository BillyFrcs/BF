      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            new about <span className="purple">Game Development.</span> with <span className="purple"> Unity Game Engine</span> My stronger and passionate is to create <span className="purple">Game Mechanics</span> and Scripting with Object Oriented Programming Language especially in <span className="purple">.NET C#</span> and doing some Debugging and Testing to find bugs and Optimizing Games. I also have some good knowledge with <span className="purple">C++ and Java.</span>
            <br />
            <br />
            I've already released a few <span className="purple">Games</span> that i've been working on by myself. You can go to my Games section to see my released Games. And if you want to see my Projects you can go to my Projects section.
            <br />
            <br />
